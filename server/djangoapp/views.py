...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        ...
        # Concat all dealer's short name
        # dealer_reviews = ' ---- '.join([dealer.sentiment for dealer in dealerships])
        dealer_reviews = ""
        for dealer in dealerships:
            dealer_reviews = dealer_reviews + dealer.sentiment+' -- '+dealer.review+'   \n'
        # Return a list of dealer short name
...
def add_review(request, dealer_id):
    if request.user.is_authenticated:
        ...
        url = 'https://us-east.functions.appdomain.cloud/api/v1/web/2bda4203-74dd-4183-b1cb-62a99d3efd8e/dealership-package/post-review'
